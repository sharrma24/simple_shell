...
/**
 * **split_string - separates a string into words, ignoring repeated delimiters
...
char **split_string(char *input_str, char *delimiter_str)
{
	...
	for (i = 0; input_str[i] != '\0'; i++)
		if (!is_delim(input_str[i], delimiter_str) &&
		    (is_delim(input_str[i + 1], delimiter_str) || !input_str[i + 1]))
			num_words++;
...
/**
 * **split_string2 - separates a string into words
 * @input_str: the input string
